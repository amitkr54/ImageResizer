...
# The new Navigation HTML with IMPROVED NAMES
new_nav_html = """<nav class="top-nav">
                    ...
                    <div class="nav-dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a href="{prefix}compress-custom.html"><i class="fas fa-file-export"></i> Compress to Custom Size</a>
                            <a href="{prefix}compress-5kb.html"><i class="fas fa-compress-arrows-alt"></i> Compress to 5KB</a>
                            <a href="{prefix}compress-10kb.html"><i class="fas fa-compress-arrows-alt"></i> Compress to 10KB</a>
                            ...
                            <a href="{prefix}compress-500kb.html"><i class="fas fa-compress-arrows-alt"></i> Compress to 500KB</a>
                        </div>
                    </div>
