...
<body data-tool="${tool.id}" data-tool-title="${tool.title}">
                ...
                <section class="workspace">
                    <div id="editor-view" class="editor-view">
                        ...
                        <div id="upload-zone" class="upload-zone">
                            <div class="upload-content">
                                <div class="upload-icon-pulse"><i class="fas fa-cloud-upload-alt"></i></div>
                                <h3>Upload Files for ${tool.title}</h3>
                                <p>Drag images or PDF here to start processing</p>
                                <span class="limit-hint">Multiple files supported</span>
                            </div>
                        </div>

                        <div id="workspace-layout" class="workspace-layout hidden">
                            ...
                            <div class="controls-area">
                                <div class="glass-card">
                                    <div id="pixel-controls" class="control-section hidden">
                                        <h3 class="section-label">Dimensions</h3>
                                        <div class="input-grid">
                                            <div class="input-block">
                                                <label>Width</label>
                                                <div class="input-wrapper"><input type="number" id="width-input"></div>
                                            </div>
                                            <div class="input-block">
                                                <label>Height</label>
                                                <div class="input-wrapper"><input type="number" id="height-input"></div>
                                            </div>
                                        </div>
                                    ...
                                    <div id="kb-controls" class="control-section hidden">
                                        <h3 class="section-label">Target Size</h3>
                                        <div class="input-block">
                                            <label>Target KB</label>
                                            <div class="input-wrapper"><input type="number" id="target-kb" value="100"></div>
                                        </div>
                                        <div class="input-block mt-1">
                                            <label>Compression Level (Quality)</label>
                                            <input type="range" id="quality-range" min="5" max="95" value="80" style="width:100%;">
                                    ...
                                    <div id="passport-controls" class="control-section hidden">
                                        <h3 class="section-label">Passport Preset</h3>
                                        <div class="input-block">
                                            <select id="passport-preset">
                                                <option value="custom">Custom Dimensions</option>
                                                <option value="2x2inch">2 x 2 Inch (US, India)</option>
                                                <option value="35x45mm">35 x 45 mm (UK, EU)</option>
                                    ...
                                    <div id="flip-controls" class="control-section hidden">
                                        <h3 class="section-label">Flip Image</h3>
                                        <div class="btn-group-row">
                                            <button id="btn-flip-h" class="btn-outline"><i class="fas fa-arrows-alt-h"></i> Horizontal</button>
                                            <button id="btn-flip-v" class="btn-outline"><i class="fas fa-arrows-alt-v"></i> Vertical</button>
                                        </div>
                                    ...
                                    <div id="crop-controls" class="control-section hidden">
                                        <h3 class="section-label">Crop Aspect Ratio</h3>
                                        <div class="btn-group-grid">
                                            <button class="btn-outline active" data-aspect-ratio="NaN">Free</button>
                                            <button class="btn-outline" data-aspect-ratio="1">1:1</button>
                                            <button class="btn-outline" data-aspect-ratio="1.3333333333">4:3</button>
                                            <button class="btn-outline" data-aspect-ratio="1.7777777778">16:9</button>
                                            <button class="btn-outline" data-aspect-ratio="0.6666666667">2:3</button>
                                        </div>
                                    </div>
                                    ...
                                    <div id="rotate-controls" class="control-section hidden">
                                        ...
                                        <div class="btn-group-row">
                                            <button id="btn-rotate-left" class="btn-outline"><i class="fas fa-undo"></i> -90°</button>
                                            <button id="btn-rotate-right" class="btn-outline"><i class="fas fa-redo"></i> +90°</button>
                                        </div>
                                    ...
                                    <div id="watermark-controls" class="control-section hidden">
                                        ...
                                        <div class="input-block">
                                            ...
                                            <div class="input-wrapper"><input type="text" id="watermark-text" placeholder="Your Brand"></div>
                                        </div>
                                        <div class="input-block mt-1">
                                        ...
                                        <div class="input-block mt-1">
                                            <label>Font Size: <span id="fontsize-value">30px</span></label>
                                            <input type="range" id="watermark-fontsize" min="10" max="150" value="30">
                                        </div>
                                        <div class="input-block mt-1">
                                            <label>Text Color</label>
                                            <div class="color-picker-wrapper">
                                                <input type="color" id="watermark-color" value="#ffffff">
                                                <span id="watermark-color-label">#FFFFFF</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div id="metadata-controls" class="control-section hidden">
                                        ...
                                        <div id="metadata-display" class="metadata-box">
                                            <p class="placeholder-text">Upload an image to see metadata</p>
                                        </div>
                                    </div>

                                    <div id="signature-controls" class="control-section hidden">
                                        <h3 class="section-label">Signature Canvas</h3>
                                        <div class="signature-wrapper">
                                            <canvas id="signature-canvas" width="300" height="150"></canvas>
                                        </div>
                                        <div class="input-block mt-1">
                                            <label>Pen Size: <span id="pensize-value">3px</span></label>
                                            <input type="range" id="signature-pensize" min="1" max="10" value="3">
                                        </div>
                                        <div class="btn-group-row mt-1">
                                            <button id="btn-clear-signature" class="btn-outline"><i class="fas fa-eraser"></i> Clear</button>
                                            <button id="btn-download-signature" class="btn-success"><i class="fas fa-download"></i> Save</button>
                                        </div>
                                    </div>

                                    <div id="instagram-bg-controls" class="control-section hidden">
                                        <h3 class="section-label">Background Color</h3>
                                        <div class="color-picker-wrapper">
                                            <input type="color" id="instagram-bg-color" value="#ffffff">
                                            <span id="bg-color-label">#FFFFFF</span>
                                        </div>
                                    </div>

                                    <div class="control-section" id="format-section">
                                        <h3 class="section-label">Output Format</h3>
                                        <div class="format-toggle">
                                            <input type="radio" name="format" id="fmt-orig" value="original" checked>
                                            <label for="fmt-orig">Original</label>
                                            <input type="radio" name="format" id="fmt-jpg" value="image/jpeg">
                                            <label for="fmt-jpg">JPG</label>
                                            <input type="radio" name="format" id="fmt-png" value="image/png">
                                            <label for="fmt-png">PNG</label>
                                            <input type="radio" name="format" id="fmt-webp" value="image/webp">
                                            <label for="fmt-webp">WebP</label>
                                        </div>
                                    </div>

                                    <div class="action-footer">
                                        <button id="process-btn" class="btn-primary"><i class="fas fa-magic"></i> Start Processing</button>
                    ...
                    <div id="results-area" class="results-area hidden">
                        <div class="results-header">
                            ...
                            <button id="download-all-btn" class="btn-success hidden"><i class="fas fa-download"></i> Download All</button>
                        </div>
